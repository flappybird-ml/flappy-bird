...
Game.prototype.display = function(){
	...
	this.ctx.font="25px Oswald, sans-serif";
	this.ctx.fillText("Score : "+ this.score, 320, 75);
	this.ctx.fillText("Max Score : "+this.maxScore, 10, 30);
	this.ctx.fillText("Generation : "+this.generation, 10, 70);
	this.ctx.fillText("Alive : "+this.alives+" / "+Neuvol.options.population, 10, 110);
